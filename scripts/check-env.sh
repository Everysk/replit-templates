...
if [ ${#MISSING_VARS[@]} -gt 0 ]; then
    ...
    echo -e "   1. Go to ${BOLD}🔒 Secrets${NC} in the Tools & Files page (add this tab at the top in your main replit workspace)"
    ...
    echo -e ""
    echo -e "   ${BLUE}Get credentials at: ${BOLD}https://app.everysk.com/api_manager/api_keys${NC}"
    echo -e ""
